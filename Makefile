...
OBJS += ggml-alloc.o ggml-backend.o ggml-quants.o unicode.o grammar-parser.o

llama.o: llama.cpp unicode.h ggml.h ggml-alloc.h ggml-backend.h ggml-cuda.h ggml-metal.h llama.h common/grammar-parser.h
	$(CXX) $(CXXFLAGS) -c $< -o $@
